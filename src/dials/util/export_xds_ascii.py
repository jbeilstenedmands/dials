    ...
    fout.write(
        "\n".join(
            [
                ...
                "!ROTATION_AXIS= {:9.6f} {:9.6f} {:9.6f}".format(*axis.elems),
                ...
                "!INCIDENT_BEAM_DIRECTION= {:f} {:f} {:f}".format(*beam.elems),
                "!NX= %d NY= %d QX= %f QY= %f" % (nx, ny, qx, qy),
                f"!ORGX= {orgx:9.2f} ORGY= {orgy:9.2f}",
                f"!DETECTOR_DISTANCE= {distance:8.3f}",
                "!DIRECTION_OF_DETECTOR_X-AXIS= {:9.5f} {:9.5f} {:9.5f}".format(
                    *fast.elems
                ),
                "!DIRECTION_OF_DETECTOR_Y-AXIS= {:9.5f} {:9.5f} {:9.5f}".format(
                    *slow.elems
                ),
                "!VARIANCE_MODEL= {:7.3e} {:7.3e}".format(*var_model),
